...
namespace Server.Gumps
{
	public class TeamKotHGump : Gump
	{
        ...
        public TeamKotHGump( TeamKotHGauntlet gauntlet, Mobile from ) : this( gauntlet, from, 0 )
		{
		}

		public TeamKotHGump( TeamKotHGauntlet gauntlet, Mobile from, int page ) : base( 20, 30 )
		{
			...
			if(gauntlet.Participants != null)
			{
                ...
                for(int i = 0;i<m_WorkingList.Count;i++)
                {
                    ...
                    TeamKotHGauntlet.ChallengeEntry entry = (TeamKotHGauntlet.ChallengeEntry)m_WorkingList[i];
			...
			switch ( info.ButtonID )
			{
				...
				default:
				{
				    ...
				    if(info.ButtonID >= 4000)
                    {
                        ...
                        {
                            TeamKotHGauntlet.ChallengeEntry entry = (TeamKotHGauntlet.ChallengeEntry)m_WorkingList[selection];
                            ...
                            if(m_gauntlet.Participants != null)
                            {
                                ...
                                foreach(TeamKotHGauntlet.ChallengeEntry masterentry in m_gauntlet.Participants)
                                {
                            ...
                            if(m_gauntlet.Participants != null)
                            {
                                ...
                                if(kickentry != null)
                                {
                                    ...
                                    if(kickentry.Participant != null)
                                    {
                                        ...
                                        kickentry.Participant.SendGump( new TeamKotHGump( m_gauntlet, kickentry.Participant, viewpage));
                                    }
                                }
                            }
		...
		private class MemberTarget : Target
        {
            ...
            public MemberTarget(TeamKotHGauntlet gauntlet, ArrayList list) :  base ( 30, false, TargetFlags.None )
            {
                m_list = list;
                m_gauntlet = gauntlet;
            }
        ...
        public class TeamsGump : Gump
        {
            ...
            public TeamsGump(TeamKotHGauntlet gauntlet, Mobile from) : base(350,30)
            { 
