...
{
	public class PrescriptionVicodin : Item 
	{
		[Constructable]
		public PrescriptionVicodin() : base( 0x14F0 )
		{
			Weight = 0.1;
			Name = "a prescription for Vicodin";
			LootType = LootType.Blessed;
		}

		public PrescriptionVicodin( Serial serial ) : base( serial )
		{
		}
