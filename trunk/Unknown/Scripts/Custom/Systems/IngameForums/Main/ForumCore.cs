...
namespace Server.Forums
{
    public class ForumCore
    {
        ...
        private static string m_SavePath = Path.Combine( Core.BaseDirectory, "Data\\Forums" ); //Save Directory
        private static int m_ThreadNumber = 0;//Thread number for next thread. !!DO NOT CHANGE THIS!!
        private static string m_Version = "1.3.5";
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register( "ViewForums", AccessLevel.Player, new CommandEventHandler( ViewForums_OnCommand ) );
            
            Console.WriteLine( "" );
            Console.WriteLine( "Sorious' Ingame Forums" );
            Console.WriteLine( "---------" );
        ...
        [Usage( "ViewForums" )]
        [Description( "Opens Sorious' Ingame Forums" )]
        public static void ViewForums_OnCommand( CommandEventArgs e )
        {
            ...
            if( ast.Banned )
            {
                pm.SendMessage( "You have been banned from this forum!" );
                return;
            }
