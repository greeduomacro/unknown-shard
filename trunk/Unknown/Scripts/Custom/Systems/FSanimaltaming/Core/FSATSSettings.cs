...
namespace Server
{
	...
	public class FSATS
	{
		...
		***********************************************/
		...
		public static readonly int NormalHITS = 4000;

		//Normal Creatures STAM Cap
		public static readonly int NormalSTAM = 4000;

		//Normal Creatures MANA Cap
		public static readonly int NormalMANA = 4000;

		//Normal Creatures Min Damage Cap
		public static readonly int NormalMinDam = 10;

		//Normal Creatures Max Damage Cap
		public static readonly int NormalMaxDam = 80;
