...
{ 
   	public class OrangePetDye : Item 
   	{ 
    
      		[Constructable] 
      		public OrangePetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 43;
      		...
      		public OrangePetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new OrangeDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class OrangeDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private OrangePetDye m_Powder; 

         		public OrangeDyeTarget( OrangePetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
