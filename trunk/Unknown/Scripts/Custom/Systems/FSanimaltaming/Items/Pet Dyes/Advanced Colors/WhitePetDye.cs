...
{ 
   	public class WhitePetDye : Item 
   	{ 
    
      		[Constructable] 
      		public WhitePetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 1150;
      		...
      		public WhitePetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new WhiteDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class WhiteDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private WhitePetDye m_Powder; 

         		public WhiteDyeTarget( WhitePetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
