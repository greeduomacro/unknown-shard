...
{ 
   	public class PinkPetDye : Item 
   	{ 
    
      		[Constructable] 
      		public PinkPetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 1166;
      		...
      		public PinkPetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new PinkDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class PinkDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private PinkPetDye m_Powder; 

         		public PinkDyeTarget( PinkPetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
