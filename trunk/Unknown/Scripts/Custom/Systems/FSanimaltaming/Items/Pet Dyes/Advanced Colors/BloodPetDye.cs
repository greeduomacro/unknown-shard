...
{ 
   	public class BloodPetDye : Item 
   	{ 
    
      		[Constructable] 
      		public BloodPetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 1157;
         		Name="pet dye (Blood Red)"; 
          	} 

      		public BloodPetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new BloodDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class BloodDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private BloodPetDye m_Powder; 

         		public BloodDyeTarget( BloodPetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
