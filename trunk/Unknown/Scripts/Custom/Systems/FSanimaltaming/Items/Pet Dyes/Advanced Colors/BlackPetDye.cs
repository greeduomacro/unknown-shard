...
{ 
   	public class BlackPetDye : Item 
   	{ 
    
      		[Constructable] 
      		public BlackPetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 1175;
      		...
      		public BlackPetDye( Serial serial ) : base( serial ) 
      		{ 
  		...
  		private class BlackDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private BlackPetDye m_Powder; 

         		public BlackDyeTarget( BlackPetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
