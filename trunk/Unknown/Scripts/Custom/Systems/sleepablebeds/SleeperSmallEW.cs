...
namespace Server.Items
{
	...
	public class SleeperSmallEWAddon: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
		...
		private SleeperSmallEWAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperSmallEWAddon Sleeper
		{
			...
			else
			{
				...
				{	
					...
					if ( m_house!= null && (m_house.IsOwner(from) || m_house.IsCoOwner(from) || m_house.IsFriend( from )))
					{
						...
						Point3D m_Location = new Point3D(this.Location.X+3, this.Location.Y, this.Location.Z+11);
	...
	public class SleeperSmallEWPiece : AddonComponent
	{

		private SleeperSmallEWAddon m_Sleeper;

		public SleeperSmallEWPiece( SleeperSmallEWAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperSmallEWAddon)reader.ReadItem();
