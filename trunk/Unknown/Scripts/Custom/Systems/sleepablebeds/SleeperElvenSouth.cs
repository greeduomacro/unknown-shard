...
namespace Server.Items
{
	...
	public class SleeperElvenSouth: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
        {
            get
            {
                return new SleeperElvenSouthDeed ();
            }
        }

		public SleeperElvenSouth( Serial serial ) : base( serial )
		{
		}

		[Constructable]
		public SleeperElvenSouth( ) 
		{
			Visible = true;
			Name = "Sleeper";
			AddComponent( new SleeperElvenSouthPiece(this, 0x3050 ), 0, 0, 0 );
			AddComponent( new SleeperElvenSouthPiece(this, 0x3051 ), 0, -1, 0 );

		}
		
		private SleeperElvenSouth m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperElvenSouth Sleeper
		{
	...
	public class SleeperElvenSouthPiece : AddonComponent
	{

		private SleeperElvenSouth m_Sleeper;

		public SleeperElvenSouthPiece( SleeperElvenSouth sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperElvenSouth)reader.ReadItem();

		}

	}
   public class SleeperElvenSouthDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new SleeperElvenSouth ();
            }
        }

        [Constructable]
        public SleeperElvenSouthDeed ()
        {
            Name = "an  elven sleepable bed facing south deed.";
        }

        public SleeperElvenSouthDeed ( Serial serial )
            : base ( serial )
        {
        }
