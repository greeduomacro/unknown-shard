...
namespace Server.Items
{
	...
	public class SleeperElvenEWAddon: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
		...
		public SleeperElvenEWAddon( ) 
		{
			Visible = true;
			Name = "Sleeper";
			AddComponent( new SleeperElvenEWPiece(this,  0x304D ), 0, 0, 0 );
			AddComponent( new SleeperElvenEWPiece(this,  0x304C ), 1, 0, 0 );
		}
		
		private SleeperElvenEWAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperElvenEWAddon Sleeper
		{
	...
	public class SleeperElvenEWPiece : AddonComponent
	{

		private SleeperElvenEWAddon m_Sleeper;

		public SleeperElvenEWPiece( SleeperElvenEWAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperElvenEWAddon)reader.ReadItem();
