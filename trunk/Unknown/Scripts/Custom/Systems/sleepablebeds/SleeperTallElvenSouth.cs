...
// Author: Oak
// Servers: RunUO 2.0
// Date: 7/10/2006 (tall elven south)
// History: 
...
namespace Server.Items
{
	...
	public class SleeperTallElvenSouth: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
        {
            get
            {
                return new SleeperTallElvenSouthDeed ();
            }
        }

		public SleeperTallElvenSouth( Serial serial ) : base( serial )
		{
		}

		[Constructable]
		public SleeperTallElvenSouth( ) 
		{
			Visible = true;
			Name = "Sleeper";
			AddComponent( new SleeperTallElvenSouthPiece( this,0x3058 ),  0,  0, 0 ); // angolo alto sx
			AddComponent( new SleeperTallElvenSouthPiece( this,0x3057 ), -1,  1, 0 ); // angolo basso sx
			AddComponent( new SleeperTallElvenSouthPiece( this,0x3059 ),  0, -1, 0 ); // angolo alto dx
			AddComponent( new SleeperTallElvenSouthPiece( this,0x3056 ),  0,  1, 0 ); // angolo basso dx

		}
		
		private SleeperTallElvenSouth m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperTallElvenSouth Sleeper
		{
	...
	public class SleeperTallElvenSouthPiece : AddonComponent
	{

		private SleeperTallElvenSouth m_Sleeper;

		public SleeperTallElvenSouthPiece( SleeperTallElvenSouth sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperTallElvenSouth)reader.ReadItem();

		}

	}
   public class SleeperTallElvenSouthDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new SleeperTallElvenSouth ();
            }
        }

        [Constructable]
        public SleeperTallElvenSouthDeed ()
        {
            Name = "a tall elven sleepable bed facing south deed.";
        }

        public SleeperTallElvenSouthDeed ( Serial serial )
            : base ( serial )
        {
        }
