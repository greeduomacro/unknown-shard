 ...
 public TreasureMap( int level, Map map )
 {
  ...
  Protected = true;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.CloseGump( typeof( CartGump ) );
				from.SendGump( new CartGump( this, entry, m_Map, m_Location ) );
			}
		...
		private class CartGump : Gump
		{
			public TreasureMap Tmap = null;
			public int xc{ get{ if( Tmap != null ) return Tmap.Loc.X; else return 0; } }
			public int yc{ get{ if( Tmap != null ) return Tmap.Loc.Y; else return 0; } }
		...
		private class MessageEntry
		{
			...
			private static MessageEntry[] m_Entries = new MessageEntry[]
				{
					new MessageEntry( 280, 180, "The treasure map is hard to make out, but with some luck and a lot of work, the red 'X' is finally discovered." )
				};
