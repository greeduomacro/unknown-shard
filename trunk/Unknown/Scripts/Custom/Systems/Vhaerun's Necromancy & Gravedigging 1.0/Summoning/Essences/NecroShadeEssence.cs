...
{
	public class NecroShadeEssence : Item
	{
		[Constructable]
		public NecroShadeEssence() : base( 0x186F )
		{
			Weight = 1.0;
			Name = "Shade Essence";
			Hue = 0x2EF;
		...
		public NecroShadeEssence( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( from.Mounted )
			{
				...
				{
					NecroShade m = new NecroShade( true, scalar );
					...
					if ( m.SetControlMaster( from ) )
					{
						...
						from.PlaySound( 0x24A );
						from.SendMessage( "You have summoned a Shade." );
					}
				}
		}
