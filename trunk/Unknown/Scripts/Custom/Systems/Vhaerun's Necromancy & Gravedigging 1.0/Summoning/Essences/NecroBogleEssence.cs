...
{
	public class NecroBogleEssence : Item
	{
		[Constructable]
		public NecroBogleEssence() : base( 0x186F )
		{
			Weight = 1.0;
			Name = "Bogle Essence";
			Hue = 0x2EF;
		...
		public NecroBogleEssence( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( from.Mounted )
			{
				...
				{
					NecroBogle m = new NecroBogle( true, scalar );
					...
					if ( m.SetControlMaster( from ) )
					{
						...
						from.PlaySound( 0x24A );
						from.SendMessage( "You have summoned a bogle." );
					}
				}
		}
