...
{
	public class NecroFleshGolemEssence : Item
	{
		[Constructable]
		public NecroFleshGolemEssence() : base( 0x186F )
		{
			Weight = 1.0;
			Name = "Flesh Golem Essence";
			Hue = 0x2EF;
		}

		public NecroFleshGolemEssence( Serial serial ) : base( serial )
		{
		}
