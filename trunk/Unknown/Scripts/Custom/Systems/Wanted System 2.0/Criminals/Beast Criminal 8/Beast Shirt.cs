...
namespace Server.Items
{
	...
	public class Beastshirt : BaseShirt 
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public Beastshirt() : this( 0 )
		{
		}

		[Constructable]
		public Beastshirt( int hue ) : base( 0x1EFD, hue )
		{
			Name = "Beast's Shirt";
			Hue = 1;
        ...
        public Beastshirt(Serial serial): base(serial) 
		{ 
			DefineMods();
