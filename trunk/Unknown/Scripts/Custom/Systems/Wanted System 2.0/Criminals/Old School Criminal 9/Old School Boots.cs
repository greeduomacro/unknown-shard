...
namespace Server.Items
{
	...
	public class OldSchoolBoots : BaseShoes
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public OldSchoolBoots() : this( 0 )
		{
		}

		[Constructable]
		public OldSchoolBoots( int hue ) : base( 0x170B, hue )
		{
			Name = "OldSchools Boots";
			Hue = 1;
		...
		{ 
			...
			{ 
				...
				m.RemoveStatMod( "OldSchoolBoots" );
        ...
        public OldSchoolBoots(Serial serial): base(serial) 
		{ 
			DefineMods();
