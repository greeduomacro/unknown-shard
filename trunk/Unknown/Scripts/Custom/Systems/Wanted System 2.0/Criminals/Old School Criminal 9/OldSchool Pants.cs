...
namespace Server.Items
{
	...
	public class OldSchoolPants : BasePants
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public OldSchoolPants() : this( 0 )
		{
		}

		[Constructable]
		public OldSchoolPants( int hue ) : base( 0x1539, hue )
		{
			Name = "OldSchool's Pants";
			Hue = 1;
		...
		{ 
			...
			{ 
				...
				m.RemoveStatMod( "OldSchoolPants" );
        ...
        public OldSchoolPants(Serial serial): base(serial) 
		{ 
			DefineMods();
