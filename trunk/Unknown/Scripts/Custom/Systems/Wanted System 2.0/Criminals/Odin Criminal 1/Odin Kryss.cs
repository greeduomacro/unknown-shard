...
namespace Server.Items
{
	...
	public class OdinKryss : BaseSword
	{
		...
		public OdinKryss() : base( 0x1401 )
		{
			...
			Attributes.LowerManaCost = 666;
			Attributes.CastRecovery = 666;
			Attributes.CastSpeed = 666;
			Attributes.Luck = 666;
			Attributes.BonusStr = 666;
			Attributes.BonusDex = 666;
			Attributes.BonusInt = 666;
			LootType = LootType.Blessed;
		}

		public OdinKryss( Serial serial ) : base( serial )
		{
		}
