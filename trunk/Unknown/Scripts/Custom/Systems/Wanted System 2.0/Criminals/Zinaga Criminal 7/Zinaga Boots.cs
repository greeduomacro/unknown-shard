...
namespace Server.Items
{
	...
	public class ZinagaBoots : BaseShoes
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public ZinagaBoots() : this( 0 )
		{
		}

		[Constructable]
		public ZinagaBoots( int hue ) : base( 0x170B, hue )
		{
			Name = "Zinagas Boots";
			Hue = 1;
        ...
        public ZinagaBoots(Serial serial): base(serial) 
		{ 
			DefineMods();
