...
namespace Server.Items
{
	...
	public class Marineshirt : BaseShirt 
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public Marineshirt() : this( 0 )
		{
		}

		[Constructable]
		public Marineshirt( int hue ) : base( 0x1EFD, hue )
		{
			Name = "Marine's Shirt";
			Hue = 1;
        ...
        public Marineshirt(Serial serial): base(serial) 
		{ 
			DefineMods();
