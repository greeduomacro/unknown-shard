...
namespace Server.Items
{
	...
	public class XerianPants : BasePants
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public XerianPants() : this( 0 )
		{
		}

		[Constructable]
		public XerianPants( int hue ) : base( 0x1539, hue )
		{
			Name = "Xerian's Pants";
			Hue = 1;
        ...
        public XerianPants(Serial serial): base(serial) 
		{ 
			DefineMods();
