...
namespace Server.Items
{
	...
	public class FreshBoots : BaseShoes
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public FreshBoots() : this( 0 )
		{
		}

		[Constructable]
		public FreshBoots( int hue ) : base( 0x170B, hue )
		{
			Name = "Freshs Boots";
			Hue = 1;
        ...
        public FreshBoots(Serial serial): base(serial) 
		{ 
			DefineMods();
