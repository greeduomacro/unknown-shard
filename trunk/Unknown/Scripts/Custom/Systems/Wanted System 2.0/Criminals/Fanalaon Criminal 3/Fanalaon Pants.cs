...
namespace Server.Items
{
	...
	public class FanalaonPants : BasePants
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public FanalaonPants() : this( 0 )
		{
		}

		[Constructable]
		public FanalaonPants( int hue ) : base( 0x1539, hue )
		{
			Name = "Fanalaon's Pants";
			Hue = 1;
        ...
        public FanalaonPants(Serial serial): base(serial) 
		{ 
			DefineMods();
