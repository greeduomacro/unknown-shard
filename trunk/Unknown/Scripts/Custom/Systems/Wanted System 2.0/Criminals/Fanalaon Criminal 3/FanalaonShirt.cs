...
namespace Server.Items
{
	...
	public class Fanalaonshirt : BaseShirt 
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public Fanalaonshirt() : this( 0 )
		{
		}

		[Constructable]
		public Fanalaonshirt( int hue ) : base( 0x1EFD, hue )
		{
			Name = "Fanalaon's Shirt";
			Hue = 1;
        ...
        public Fanalaonshirt(Serial serial): base(serial) 
		{ 
			DefineMods();
