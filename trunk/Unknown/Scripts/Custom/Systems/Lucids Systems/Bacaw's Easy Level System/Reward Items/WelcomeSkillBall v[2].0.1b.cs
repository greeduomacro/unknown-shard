...
//  Made into a WelcomeSkillBall by X-SirSly-X
...
{
	public class WelcomeSkillBall : Item
	{
		...
		[Constructable]
		public WelcomeSkillBall( int SkillBonus, int SkillBallCap ) : base( 6249 )
		{
		...
		public WelcomeSkillBall( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				GumpOpen = true;
				from.SendGump( new WelcomeSkillBallGump( from, this ) );
			}
			else if (GumpOpen)
...
{
	public class WelcomeSkillBallGump : Gump
	{
		private Skill m_Skill;
		private WelcomeSkillBall m_skb;
		
		public WelcomeSkillBallGump ( Mobile from, WelcomeSkillBall skb ) : base ( 20, 30 )
		{
