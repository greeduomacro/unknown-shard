//////////////////////////////////////////////////////////////////////////////////////////////
// Necromancer Custom AI
// Parts of the NecroAI based on or taken from the
// RunUO 1.0 RC0 Mage AI
// Thanks to the Guys at RunUO for RunUO :-)
// Version: 1.0 Final
// Coded by: Final Realms
// Thnxs to Darklon for his help & support with this script.
// Thnxs to Admin Maeve for her help & support with this script.
	...
	public class NecroAI : BaseAI
	{
		...
		public override bool DoActionWander()
		{
			...
			else
			{
				...
				else if ( !m_Mobile.Summoned && (SmartAI || (ScaleByNecromancy( HealChance ) > Utility.RandomDouble())) )
				{
		...
		{
			if ( !m_Mobile.DisallowAllMoves && (SmartAI ? Utility.Random( 4 ) == 0 : ScaleByNecromancy( TeleportChance ) > Utility.RandomDouble()) )
			{
		...
		public virtual Spell GetRandomDamageSpell()
		{
			...
			switch ( Utility.Random( maxCircle*2 ) )
			{
				...
				case  2: case  3: return new BloodOathSpell( m_Mobile, null );
				case  4: case  5: return new EvilOmenSpell( m_Mobile, null );
				case  6: case  7: return new MindRotSpell( m_Mobile, null );
				case  8: case  9: return new StrangleSpell( m_Mobile, null );
		...
		public virtual Spell DoDispel( Mobile toDispel )
		{
			if ( !SmartAI )
			{
				if ( ScaleByNecromancy( DispelChance ) > Utility.RandomDouble() )
