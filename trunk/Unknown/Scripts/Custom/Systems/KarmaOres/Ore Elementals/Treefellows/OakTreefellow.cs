...
namespace Server.Mobiles
{
	...
	public class OakTreefellow : BaseCreature
	{
		...
		[Constructable]
		public OakTreefellow() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a oak treefellow";
			Body = 301;
			Hue = 1190;
			...
			PackItem( new OakLog( Utility.RandomMinMax( 13, 24 ) ) );
			
			if ( 0.5 > Utility.RandomDouble() )
				PackItem( new RunicOa() );
