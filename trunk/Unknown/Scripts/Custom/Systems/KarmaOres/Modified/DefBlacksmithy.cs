	...
	public class DefBlacksmithy : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			*/
			...
			AddSubRes( typeof( SilverIngot ),       	"SILVER", 80.0, 1044268 );
			AddSubRes( typeof( PlatinumIngot ),     	"PLATINUM", 85.0, 1044268 );
			AddSubRes( typeof( MythrilIngot ),      	"MYTHRIL", 90.0, 1044268 );
			AddSubRes( typeof( ObsidianIngot ),     	"OBISDIAN", 95.0, 1044268 );			
			AddSubRes( typeof( JadeIngot ),         	"JADE", 100.0, 1044268 );
			AddSubRes( typeof( MoonstoneIngot ),    	"MOONSTONE", 105.0, 1044268 );
			AddSubRes( typeof( SunstoneIngot ),     	"SUNSTONE", 110.0, 1044268 );
			AddSubRes( typeof( BloodstoneIngot ),   	"BLOODSTONE", 115.0, 1044268 );
