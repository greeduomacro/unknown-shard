...
namespace Server.Items
{
	...
	public class JadeOre : BaseOre
	{
		[Constructable]
		public JadeOre() : this( 1 )
		{
		}

		[Constructable]
		public JadeOre( int amount ) : base( CraftResource.Jade, amount )
		{
		}

		public JadeOre( Serial serial ) : base( serial )
		{
		}
		...
		public override BaseIngot GetIngot()
		{
			return new JadeIngot();
		}
	}
	public class MoonstoneOre : BaseOre
	{
		[Constructable]
		public MoonstoneOre() : this( 1 )
		{
		}

		[Constructable]
		public MoonstoneOre( int amount ) : base( CraftResource.Moonstone, amount )
		{
		}

		public MoonstoneOre( Serial serial ) : base( serial )
		{
		}
	...
	public class SunstoneOre : BaseOre
	{
		[Constructable]
		public SunstoneOre() : this( 1 )
		{
		}

		[Constructable]
		public SunstoneOre( int amount ) : base( CraftResource.Sunstone, amount )
		{
		}

		public SunstoneOre( Serial serial ) : base( serial )
		{
		}
	...
	{
		[Constructable]
		public BloodstoneOre() : this( 1 )
		{
		}

		[Constructable]
		public BloodstoneOre( int amount ) : base( CraftResource.Bloodstone, amount )
		{
		}

		public BloodstoneOre( Serial serial ) : base( serial )
		{
		}
