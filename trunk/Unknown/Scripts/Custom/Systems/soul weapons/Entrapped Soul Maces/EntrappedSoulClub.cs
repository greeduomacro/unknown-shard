...
{
	public class EntrappedSoulClub : Club
	{
		...
		[Constructable]
		public EntrappedSoulClub()
		{
			Name = "Entrapped Soul Club";
		...
		{
			private EntrappedSoulClub i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulClub std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulClub( Serial serial ) : base( serial ) { }
