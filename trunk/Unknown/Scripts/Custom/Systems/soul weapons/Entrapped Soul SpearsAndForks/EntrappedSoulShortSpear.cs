...
{
	public class EntrappedSoulShortSpear : ShortSpear
	{
		...
		[Constructable]
		public EntrappedSoulShortSpear()
		{
			Name = "Entrapped Soul Short Spear";
		...
		{
			private EntrappedSoulShortSpear i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulShortSpear std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulShortSpear( Serial serial ) : base( serial ) { }
