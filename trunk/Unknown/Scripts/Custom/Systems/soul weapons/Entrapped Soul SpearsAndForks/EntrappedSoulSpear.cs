...
{
	public class EntrappedSoulSpear : Spear
	{
		...
		[Constructable]
		public EntrappedSoulSpear()
		{
			Name = "Entrapped Soul Spear";
		...
		{
			private EntrappedSoulSpear i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulSpear std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulSpear( Serial serial ) : base( serial ) { }
