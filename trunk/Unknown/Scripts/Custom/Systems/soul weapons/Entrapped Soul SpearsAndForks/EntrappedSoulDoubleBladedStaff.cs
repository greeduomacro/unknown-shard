...
{
	public class EntrappedSoulDoubleBladedStaff : DoubleBladedStaff
	{
		...
		[Constructable]
		public EntrappedSoulDoubleBladedStaff()
		{
			Name = "Entrapped Soul Double Bladed Staff";
		...
		{
			private EntrappedSoulDoubleBladedStaff i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulDoubleBladedStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulDoubleBladedStaff( Serial serial ) : base( serial ) { }
