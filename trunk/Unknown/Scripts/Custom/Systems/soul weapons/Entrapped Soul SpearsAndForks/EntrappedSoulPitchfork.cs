...
{
	public class EntrappedSoulPitchfork : Pitchfork
	{
		...
		[Constructable]
		public EntrappedSoulPitchfork()
		{
			Name = "Entrapped Soul Pitchfork";
		...
		{
			private EntrappedSoulPitchfork i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulPitchfork std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulPitchfork( Serial serial ) : base( serial ) { }
