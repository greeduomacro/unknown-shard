...
{
	public class EntrappedSoulRepeatingCrossbow : RepeatingCrossbow
	{
		...
		[Constructable]
		public EntrappedSoulRepeatingCrossbow()
		{
			Name = "Entrapped Soul Repeating Crossbow";
		...
		{
			private EntrappedSoulRepeatingCrossbow i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulRepeatingCrossbow std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulRepeatingCrossbow( Serial serial ) : base( serial ) { }
