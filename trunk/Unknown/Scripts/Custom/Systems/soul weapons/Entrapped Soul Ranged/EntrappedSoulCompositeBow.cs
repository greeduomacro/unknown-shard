...
{
	public class EntrappedSoulCompositeBow : CompositeBow
	{
		...
		[Constructable]
		public EntrappedSoulCompositeBow()
		{
			Name = "Entrapped Soul Composite Bow";
		...
		{
			private EntrappedSoulCompositeBow i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulCompositeBow std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulCompositeBow( Serial serial ) : base( serial ) { }
