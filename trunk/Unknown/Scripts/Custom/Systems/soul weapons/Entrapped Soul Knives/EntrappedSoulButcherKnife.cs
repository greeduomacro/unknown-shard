...
{
	public class EntrappedSoulButcherKnife : ButcherKnife
	{
		...
		[Constructable]
		public EntrappedSoulButcherKnife()
		{
			Name = "Entrapped Soul Butcher Knife";
		...
		{
			private EntrappedSoulButcherKnife i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulButcherKnife std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulButcherKnife( Serial serial ) : base( serial ) { }
