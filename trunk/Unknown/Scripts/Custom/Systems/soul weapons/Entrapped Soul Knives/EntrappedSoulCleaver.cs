...
{
	public class EntrappedSoulCleaver : Cleaver
	{
		...
		[Constructable]
		public EntrappedSoulCleaver()
		{
			Name = "Entrapped Soul Cleaver";
		...
		{
			private EntrappedSoulCleaver i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulCleaver std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulCleaver( Serial serial ) : base( serial ) { }
