...
{
	public class EntrappedSoulKryss : Kryss
	{
		...
		[Constructable]
		public EntrappedSoulKryss()
		{
			Name = "Entrapped Soul Kryss";
		...
		{
			private EntrappedSoulKryss i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulKryss std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulKryss( Serial serial ) : base( serial ) { }
