...
{
	public class EntrappedSoulLongSword : Longsword
	{
		...
		[Constructable]
		public EntrappedSoulLongSword()
		{
			Name = "Entrapped Soul Long Sword";
		...
		{
			private EntrappedSoulLongSword i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulLongSword std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulLongSword( Serial serial ) : base( serial ) { }
