...
{
	public class EntrappedSoulBroadSword : Broadsword
	{
		...
		[Constructable]
		public EntrappedSoulBroadSword()
		{
			Name = "Entrapped Soul Broad Sword";
		...
		{
			private EntrappedSoulBroadSword i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulBroadSword std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulBroadSword( Serial serial ) : base( serial ) { }
