...
{
	public class EntrappedSoulScimitar : Scimitar
	{
		...
		[Constructable]
		public EntrappedSoulScimitar()
		{
			Name = "Entrapped Soul Scimitar";
		...
		{
			private EntrappedSoulScimitar i_Std;
			private int m_Charges;
		...
		public EntrappedSoulScimitar( Serial serial ) : base( serial ) { }
