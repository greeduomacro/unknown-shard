...
{
	public class EntrappedSoulCrescentBlade : CrescentBlade
	{
		...
		[Constructable]
		public EntrappedSoulCrescentBlade()
		{
			Name = "Entrapped Soul Crescent Blade";
		...
		{
			private EntrappedSoulCrescentBlade i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulCrescentBlade std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulCrescentBlade( Serial serial ) : base( serial ) { }
