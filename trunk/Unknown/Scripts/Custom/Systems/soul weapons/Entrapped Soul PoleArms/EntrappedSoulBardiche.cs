...
{
	public class EntrappedSoulBardiche : Bardiche
	{
		...
		[Constructable]
		public EntrappedSoulBardiche()
		{
			Name = "Entrapped Soul Bardiche";
		...
		{
			private EntrappedSoulBardiche i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulBardiche std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulBardiche( Serial serial ) : base( serial ) { }
