...
{
	public class EntrappedSoulGnarledStaff : GnarledStaff
	{
		...
		[Constructable]
		public EntrappedSoulGnarledStaff()
		{
			Name = "Entrapped Soul Gnarled Staff";
		...
		{
			private EntrappedSoulGnarledStaff i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulGnarledStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulGnarledStaff( Serial serial ) : base( serial ) { }
