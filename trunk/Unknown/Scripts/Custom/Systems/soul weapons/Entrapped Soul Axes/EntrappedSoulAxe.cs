...
{
	public class EntrappedSoulAxe : Axe
	{
		...
		[Constructable]
		public EntrappedSoulAxe()
		{
			Name = "Entrapped Soul Axe";
		...
		{
			private EntrappedSoulAxe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulAxe( Serial serial ) : base( serial ) { }
