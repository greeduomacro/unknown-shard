...
{
	public class EntrappedSoulHatchet : Hatchet
	{
		...
		[Constructable]
		public EntrappedSoulHatchet()
		{
			Name = "Entrapped Soul Hatchet";
		...
		{
			private EntrappedSoulHatchet i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulHatchet std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulHatchet( Serial serial ) : base( serial ) { }
