...
{
	public class EntrappedSoulBattleAxe : BattleAxe
	{
		...
		[Constructable]
		public EntrappedSoulBattleAxe()
		{
			Name = "Entrapped Soul Battle Axe";
		...
		{
			private EntrappedSoulBattleAxe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulBattleAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulBattleAxe( Serial serial ) : base( serial ) { }
