...
{
	public class EntrappedSoulDoubleAxe : DoubleAxe
	{
		...
		[Constructable]
		public EntrappedSoulDoubleAxe()
		{
			Name = "Entrapped Soul Double Axe";
		...
		{
			private EntrappedSoulDoubleAxe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulDoubleAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulDoubleAxe( Serial serial ) : base( serial ) { }
