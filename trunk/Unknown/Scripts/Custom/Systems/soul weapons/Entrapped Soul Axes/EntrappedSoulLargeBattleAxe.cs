...
{
	public class EntrappedSoulLargeBattleAxe : LargeBattleAxe
	{
		...
		[Constructable]
		public EntrappedSoulLargeBattleAxe()
		{
			Name = "Entrapped Soul Large Battle Axe";
		...
		{
			private EntrappedSoulLargeBattleAxe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulLargeBattleAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulLargeBattleAxe( Serial serial ) : base( serial ) { }
