...
{
	public class EntrappedSoulWarAxe : WarAxe
	{
		...
		[Constructable]
		public EntrappedSoulWarAxe()
		{
			Name = "Entrapped Soul War Axe";
		...
		{
			private EntrappedSoulWarAxe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulWarAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulWarAxe( Serial serial ) : base( serial ) { }
