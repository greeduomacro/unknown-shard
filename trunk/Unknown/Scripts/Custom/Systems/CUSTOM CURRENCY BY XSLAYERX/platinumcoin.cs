...
namespace Server.Items
{
	public class Platinumcoin : Item
	{
		...
		[Constructable]
		public Platinumcoin() : this( 1 )
        {
        }

		[Constructable]
		public Platinumcoin( int amountFrom, int amountTo ) : this( Utility.RandomMinMax( amountFrom, amountTo ) )
		{
		}

		[Constructable]
		public Platinumcoin( int amount ) : base( 0xEED )
		{
			Stackable = true;
			Amount = amount;
            Hue = 1153;
        ...
        public Platinumcoin(Serial serial)
            : base(serial)
		{
		}
