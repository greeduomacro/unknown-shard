...
namespace Server
{
	public class LevelItems
	{
        ...
        public static readonly int MaxLevelsCap = 200; //Number of total levels items can go up to when maxed.
        ...
        public static readonly int PointsPerLevel = 6; //How many spending points an item gets per level.
