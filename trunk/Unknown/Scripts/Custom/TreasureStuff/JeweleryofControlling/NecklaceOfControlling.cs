...
{
	public class NecklaceOfControlling : Necklace
	{

		[Constructable]
		public NecklaceOfControlling()
		{
			Name = "Necklace of Controlling";
		}

		public NecklaceOfControlling( Serial serial ) : base( serial )
		{
		}
