...
namespace Server.Mobiles
{
	...
	public class RDaemon : BaseMount
	{

		
		[Constructable]
		public RDaemon() : this( "a ridable Daemon" )
		{
		}
		...
		[Constructable]
		public RDaemon ( string name ) : base( name, 0x9, 0x3F09, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "a ridable daemon" );
			Body = 9;
			BaseSoundID = 357;
