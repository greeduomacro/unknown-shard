...
namespace Server.Mobiles
{
	...
	public class RScorpion : BaseMount
	{
		
		[Constructable]
		public RScorpion() : this( "a ridable scorpion" )
		{
		}

		[Constructable]
		public RScorpion( string name ) : base( name, 0x30, 0x3F0F, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a ridable scorpion";
			Body = 48;
			BaseSoundID = 397;
