...
"<BASEFONT COLOR=ORANGE>I congratulate you young adventurer! Very few found the answer to it! *smiles*<BR><BR>" +
"<BASEFONT COLOR=ORANGE>Now take this phial and deliver it to the Oracle who needs it.<BR><BR>" +
"<BASEFONT COLOR=ORANGE><I>The God will give you the Element of Earth.</I> Hurry, the time is short!<BR><BR>" +
            "</BODY>", false, true);
