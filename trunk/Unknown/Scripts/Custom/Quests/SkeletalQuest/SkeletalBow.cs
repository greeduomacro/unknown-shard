...
namespace Server.Items
{
    ...
    public class SkeletalBow : BaseLevelRanged
	{
		public override int EffectID{ get{ return 0xF42; } }
		public override Type AmmoType{ get{ return typeof( Arrow ); } }
		public override Item Ammo{ get{ return new SkeletalArrow(); } }
		...
		[Constructable]
		public SkeletalBow() : base( 0x27A5 )
		{
			Name = "Skeletal Bow";
			Hue = 1950;
			Weight = 9.0;
		...
		public SkeletalBow( Serial serial ) : base( serial )
		{
		}
