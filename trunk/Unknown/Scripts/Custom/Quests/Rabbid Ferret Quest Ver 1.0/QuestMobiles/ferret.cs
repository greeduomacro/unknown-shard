// A Tunneling Ferret/ Mods can make tamable  * these are mean lil shits adjust stats*
// scripted by evilfreak
// Ver 1.0
// look for edits throughout script for making these tamable or adjusting time on tunneling
...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public Ferret() : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.2, 0.4 )
		{
			Name = "a ferret";
			Body = 279;
