...
{
    public class BoogieWoogieWuGloves : BoneGloves
    {
        ...
        [Constructable]
        public BoogieWoogieWuGloves()
        {
            Name = "Boogie Woogie Wu Gloves";
            Hue = 1153;
        ...
        public BoogieWoogieWuGloves(Serial serial) : base( serial )
        {
        }
