...
{ 
   public class ChiefParoxysmusIdol : Item 
   { 
      [Constructable] 
      public ChiefParoxysmusIdol() : base( 11650 ) 
      { 
         Movable = true; 
         Name = "Chief Paroxysmus Idol";  
         LootType = LootType.Cursed; 
      } 

      public ChiefParoxysmusIdol( Serial serial ) : base( serial ) 
      { 
      } 
