...
namespace Server.Items
{
	...
	public class ChiefParoxysmusKey : Item
	{

		[Constructable]
		public ChiefParoxysmusKey() : this( null )
		{
		}
		
		[Constructable]
		public ChiefParoxysmusKey( string name ) : base( 0x2258 )
		{
		...
		public class ChiefParoxysmusGump : Gump
		{
		private Mobile m_Mobile;
		private Item m_Deed;
		
		public ChiefParoxysmusGump( Mobile from, Item deed ) : base( 30, 20 )
		{
			m_Mobile = from;
			m_Deed = deed;
			...
			AddLabel( 140, 60, 0x34, "Destroy Chief Paroxysmus" );
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
					{
						from.CloseGump( typeof( ChiefParoxysmusGump ) );
						break;
					}
