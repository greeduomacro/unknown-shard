...
{
	public class AAlchemistContract : Item
	{
		//public override int LabelNumber{ get{ return 1041243; } } // a contract of employment

		[Constructable]
		public AAlchemistContract() : base( 0x2831 )
		{
		    Hue = 37;
		    Name = "Alchemist Contract";
			Weight = 0.1;
			LootType = LootType.Blessed;
		}

		public AAlchemistContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new AAlchemist();//( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new AAlchemist();//( from, house );
