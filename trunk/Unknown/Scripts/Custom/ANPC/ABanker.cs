...
namespace Server.Mobiles
{
	public class ABanker : BaseVendor
	{
		...
		[Constructable]
		public ABanker() : base( "The Banker" )
		{
		    CantWalk = true;
		}
		...
		public ABanker( Serial serial ) : base( serial )
		{
		}
		...
		public override void AddCustomContextEntries( Mobile from, List<ContextMenuEntry> list )  //( Mobile from, ArrayList list )
		{
			if ( from.Alive )
