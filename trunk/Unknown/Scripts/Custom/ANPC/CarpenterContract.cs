...
{
	public class ACarpenterContract : Item
	{

		[Constructable]
		public ACarpenterContract() : base( 0x2831 )
		{
		    Hue = 1265;
		    Name = "Carpenter Contract";
			Weight = 0.1;
			LootType = LootType.Blessed;
		}

		public ACarpenterContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new ACarpenter();//( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new ACarpenter();//( from, house );
