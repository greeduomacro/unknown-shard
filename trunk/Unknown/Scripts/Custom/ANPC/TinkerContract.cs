...
{
	public class ATinkerContract : Item
	{

		[Constructable]
		public ATinkerContract() : base( 0x2831 )
		{
		    Hue = 95;
		    Name = "Tinker Contract";
			Weight = 0.1;
			LootType = LootType.Blessed;
		}

		public ATinkerContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new ATinker();//( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new ATinker();//( from, house );
