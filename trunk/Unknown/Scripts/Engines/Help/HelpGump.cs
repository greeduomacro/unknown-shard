	...
	public class HelpGump : Gump
	{
		...
		public HelpGump( Mobile from ) : base( 0, 0 )
		{
			...
			if ( isYoung )
			{
				...
				AddHtml( 110, 270, 450, 58, @"<u>Another player is harassing me.</u> Another Player is verbally harassing your character and it is bothering you.", true, true );

				AddButton( 80, 335, 5540, 5541, 0, GumpButtonType.Page, 2 );
				AddHtml( 110, 335, 450, 58, @"<u>Other.</u> Any problems that your having that you have not found help with can be posted on (http://uotest.ownforum.org/index.php).", true, true );
			}
			else
			{
				...
				AddHtml( 110, 250, 450, 74, @"<u>Another player is harassing me.</u> Another Player is verbally harassing your character and it is bothering you.", true, true );

				AddButton( 80, 330, 5540, 5541, 0, GumpButtonType.Page, 2 );
				AddHtml( 110, 330, 450, 74, @"<u>Other.</u> Any problems that your having that you have not found help with can be posted on (http://uotest.ownforum.org/index.php).", true, true );
			}
