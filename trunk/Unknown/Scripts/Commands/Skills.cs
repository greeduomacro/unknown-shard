...
namespace Server.Commands
{
	public class SkillsCommand
	{
		public static void Initialize()
		{
			...
			CommandSystem.Register( "SetAllSkillsCap", AccessLevel.GameMaster, new CommandEventHandler( SetAllSkillsCap_OnCommand ) );
		}
		...
		[Usage( "SetAllSkillsCap <name> <value>" )]
		[Description( "Sets all skill Caps values of a targeted mobile." )]
		public static void SetAllSkillsCap_OnCommand( CommandEventArgs arg )
		{
			if ( arg.Length != 1 )
			{
				arg.Mobile.SendMessage( "SetAllSkillsCap <value>" );
			}
			else
			{
				arg.Mobile.Target = new AllSkillsCapTarget( arg.GetDouble( 0 ) );
			}
		}
		...
		public class AllSkillsCapTarget : Target
		{
			private double m_Value;

			public AllSkillsCapTarget( double value ) : base( -1, false, TargetFlags.None )
			{
				m_Value = value;
			}
