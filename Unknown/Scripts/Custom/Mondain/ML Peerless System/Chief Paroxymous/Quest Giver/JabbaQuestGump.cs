...
{
	public class JabbaQuestGump : Gump
	{
		public JabbaQuestGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( JabbaQuestGump ) );
					from.AddToBackpack(new JabbaMarker());
					from.AddToBackpack(new JabbaQuestBook());
