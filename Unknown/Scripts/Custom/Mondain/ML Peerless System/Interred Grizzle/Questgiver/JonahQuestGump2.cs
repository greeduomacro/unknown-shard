...
{
	public class JonahQuestGump2 : Gump
	{
		public JonahQuestGump2( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Grizzles Demise");
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( JonahQuestGump2 ) );
					break;
				}
