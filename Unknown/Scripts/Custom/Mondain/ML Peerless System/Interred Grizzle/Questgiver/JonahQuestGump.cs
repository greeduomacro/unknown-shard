...
{
	public class JonahQuestGump : Gump
	{
		public JonahQuestGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( JonahQuestGump ) );
					from.AddToBackpack(new JonahMarker());
					from.AddToBackpack(new JonahQuestBook());
