...
{ 
   public class ShadowKnightIdol : Item 
   { 
      [Constructable] 
      public ShadowKnightIdol() : base( 9771 ) 
      { 
         Movable = true; 
         Name = "Shadow Knight Idol";  
         //LootType = LootType.Blessed; 
      } 

      public ShadowKnightIdol( Serial serial ) : base( serial ) 
      { 
      } 
