...
{ 
   public class DeathwatchBeetleIdol : Item 
   { 
      [Constructable] 
      public DeathwatchBeetleIdol() : base( 10085 ) 
      { 
         Movable = true; 
         Name = "DeathwatchBeetle Idol";  
         //LootType = LootType.Blessed; 
      } 

      public DeathwatchBeetleIdol( Serial serial ) : base( serial ) 
      { 
      } 
