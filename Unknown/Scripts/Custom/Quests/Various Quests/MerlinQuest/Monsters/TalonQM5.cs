...
namespace Server.Mobiles
{
    ...
    public class Talon5 : BaseCreature
    {
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                if (a != null)
                {
                    pm.AddToBackpack(new MerlinsStaff2());
                    pm.AddToBackpack(new MerlinsBook2());
                    pm.SendMessage("You gather Merlins items and head toward Nujelm to find him");
                }
                else
                {
                    pm.SendMessage("You are to late in retrieving the items");
                }
            ...
            else if (m is BaseCreature)
            {
                ...
                if (bc.Controlled == true)
                {
                    ...
                    if (a != null)
                    {
                        bc.ControlMaster.AddToBackpack(new MerlinsStaff2());
                        bc.ControlMaster.AddToBackpack(new MerlinsBook2());
                        bc.ControlMaster.SendMessage("You gather Merlins items and head toward Nujelm to find him");
                    }
                    else
                    {
