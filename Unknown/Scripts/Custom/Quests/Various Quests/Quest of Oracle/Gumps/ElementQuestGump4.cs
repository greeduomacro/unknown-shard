...
"<BASEFONT COLOR=ORANGE>Please, don't quit on me now!<BR><BR>" +
"<BASEFONT COLOR=ORANGE>Here is third Riddle.<BR><BR>" +
...
"<BASEFONT COLOR=ORANGE><I>Without ever having them learned.</I><BR><BR>" +
...
"<BASEFONT COLOR=ORANGE>Go to see him, speak his name and the answer and return me the Element of Water.<BR><BR>" +
