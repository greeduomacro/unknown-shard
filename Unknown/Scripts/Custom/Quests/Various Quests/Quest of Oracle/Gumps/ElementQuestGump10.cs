...
"<BASEFONT COLOR=ORANGE>As promised, here is your reward richly deserved.<BR><BR>" +
"<BASEFONT COLOR=ORANGE><I>The Pythie gives him a Bracelet of Elements.</I><BR><BR>" +
"<BASEFONT COLOR=ORANGE>This will be a big help for you.<BR><BR>" +
