// A Ferret  * these are mean lil shits adjust stats*
...
namespace Server.Mobiles
{
	...
	public class Ferretnon : BaseCreature
	{
		[Constructable]
		public Ferretnon() : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.2, 0.4 )
		{
			Name = "a ferret";
			Body = 279;
...
//here is the line to edit the time before it tunnels off  TimeSpan.FromMinutes( minutes here)
			Timer.DelayCall( TimeSpan.FromMinutes( 1.0 ), new TimerCallback( BeginTunnel ) );
		}
		...
		public virtual void BeginTunnel()
		{
			...
			Frozen = true;
			Say( "* The ferret kicks loose brick,and dirt everywhere!! *" );
			PlaySound( 0x247 );
			PlaySound( 0x247 );
...
*/
		...
		public Ferretnon( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			//DelayBeginTunnel();//edit this out 
		}
	}
}