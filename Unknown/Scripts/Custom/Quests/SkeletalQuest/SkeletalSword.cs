...
namespace Server.Items
{
	...
	public class SkeletalSword : BaseLevelSword
	{
		...
		public override int InitMaxHits{ get{ return 170; } }

		[Constructable]
		public SkeletalSword() : base( 0x26BB )
		{
			Name = "Skeletal Sword";
			Hue = 1950;
			Weight = 3.0;
		...
		public SkeletalSword( Serial serial ) : base( serial )
		{
		}
