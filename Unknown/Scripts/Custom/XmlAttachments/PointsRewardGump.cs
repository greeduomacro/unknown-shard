	...
	public class PointsRewardGump : Gump
	{
		...
		{ 
            ...
            */
			...
			AddHtml( 40, 20, 350, 50, "Rewards Available for Purchase with Points Credits", false, false );
			
			AddLabel( 400, 20, 0, String.Format("Available Credits: {0}", XmlPoints.GetCredits(from) ));
