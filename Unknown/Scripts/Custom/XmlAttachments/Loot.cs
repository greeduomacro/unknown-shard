...
namespace Server
{
	public class Loot
	{
        ...
        //ARTEGORDONMOD
		// begin mod to support lootpack drops of new augmentations
		// -----------------------------------------------------
		
		// begin new augmentations
		
		public static Type[] GlimmeringStoneAugmentTypes{ get{ return m_GlimmeringStoneAugmentTypes; } }

		private static Type[] m_GlimmeringStoneAugmentTypes = new Type[]
			{
				typeof( GlimmeringGranite ),			typeof( GlimmeringClay ),
				typeof( GlimmeringHeartstone ),			typeof( GlimmeringGypsum ),           typeof( GlimmeringIronOre ),
				typeof( GlimmeringOnyx ),           typeof( GlimmeringMarble ),           typeof( GlimmeringPetrifiedWood ),
				typeof( GlimmeringLimestone ),           typeof( GlimmeringBloodrock )
			};
		
		public static Type[] RadiantCrystalAugmentTypes{ get{ return m_RadiantCrystalAugmentTypes; } }

		private static Type[] m_RadiantCrystalAugmentTypes = new Type[]
			{
				typeof( RadiantWyrCrystal ),			typeof( RadiantVelCrystal ),
				typeof( RadiantRhoCrystal ),			typeof( RadiantFreCrystal ),           typeof( RadiantXenCrystal ),
				typeof( RadiantPolCrystal ),           typeof( RadiantWolCrystal ),           typeof( RadiantBalCrystal ),
				typeof( RadiantTalCrystal ),           typeof( RadiantJalCrystal ),           typeof( RadiantRalCrystal ),
				typeof( RadiantKalCrystal ),           typeof( RadiantRysCrystal ),			typeof( RadiantTorCrystal )
			};


		public static Type[] CrystalAugmentTypes{ get{ return m_CrystalAugmentTypes; } }

		private static Type[] m_CrystalAugmentTypes = new Type[]
			{
				typeof( FenCrystal ),			typeof( WyrCrystal ),			typeof( VelCrystal ),
				typeof( RhoCrystal ),			typeof( FreCrystal ),           typeof( XenCrystal ),
				typeof( PolCrystal ),           typeof( WolCrystal ),           typeof( BalCrystal ),
				typeof( TalCrystal ),           typeof( JalCrystal ),           typeof( RalCrystal ),
				typeof( KalCrystal ),           typeof( RysCrystal ),			typeof( TorCrystal )
			};
		
		public static Type[] RuneAugmentTypes{ get{ return m_RuneAugmentTypes; } }

		private static Type[] m_RuneAugmentTypes = new Type[]
			{
				typeof( TyrRune ),			typeof( MefRune ),			typeof( JorRune ),
				typeof( AhmRune ),			typeof( YlmRune ),
				typeof( MorRune ),			typeof( KotRune )
			};
			

		public static Type[] MythicAugmentTypes{ get{ return m_MythicAugmentTypes; } }

		private static Type[] m_MythicAugmentTypes = new Type[]
			{
				typeof( MythicDiamond ),			typeof( MythicAmethyst ),  typeof( MythicSapphire ),
				typeof( MythicRuby ),			typeof( MythicSkull ),  typeof( MythicTourmaline ),
				typeof( MythicEmerald ),			typeof( MythicWood )
			};


		public static Type[] LegendaryAugmentTypes{ get{ return m_LegendaryAugmentTypes; } }

		private static Type[] m_LegendaryAugmentTypes = new Type[]
			{
				typeof( LegendaryDiamond ),			typeof( LegendaryAmethyst ), typeof( LegendarySapphire ),
				typeof( LegendaryRuby ),			typeof( LegendarySkull ),  typeof( LegendaryTourmaline ),
				typeof( LegendaryEmerald ),			typeof( LegendaryWood )
			};
			

		public static Type[] AncientAugmentTypes{ get{ return m_AncientAugmentTypes; } }

		private static Type[] m_AncientAugmentTypes = new Type[]
			{
				typeof( AncientDiamond ),			typeof( AncientAmethyst ),  typeof( AncientSapphire ),
				typeof( AncientRuby ),			typeof( AncientSkull ),        typeof( AncientTourmaline ),
				typeof( AncientEmerald ),			typeof( AncientWood )
			};
			
		public static Item RandomGlimmeringStoneAugment()
		{
			return Construct( m_GlimmeringStoneAugmentTypes );
		}
			
		public static Item RandomRadiantCrystalAugment()
		{
			return Construct( m_RadiantCrystalAugmentTypes );
		}

		public static Item RandomCrystalAugment()
		{
			return Construct( m_CrystalAugmentTypes );
		}

		public static Item RandomRuneAugment()
		{
			return Construct( m_RuneAugmentTypes );
		}
		
		public static Item RandomMythicAugment()
		{
			return Construct( m_MythicAugmentTypes );
		}

		public static Item RandomLegendaryAugment()
		{
			return Construct( m_LegendaryAugmentTypes );
		}

		public static Item RandomAncientAugment()
		{
			return Construct( m_AncientAugmentTypes );
		}
		
		public static Item RandomAugment()
		{
			int level = Utility.Random(1000);
			// 1% of a radiant, 1% of a mythic, 5% of a crystal, 5% of a rune, 13% chance of a legendary, 10% change of a glimmering, 65% chance of ancient augment
			if(level < 10)
                return RandomRadiantCrystalAugment();
            else
			if(level < 20)
                return RandomMythicAugment();
            else
			if(level < 70)
                return RandomCrystalAugment();
            else
            if(level < 200)
                return RandomLegendaryAugment();
            else
            if(level < 300)
                return RandomGlimmeringStoneAugment();
            else
            if(level < 350)
                return RandomRuneAugment();
            else
                return RandomAncientAugment();
		}
		// end of augmentations mod
