...
namespace Server
{
	public class OppositionGroup
	{
        ...
        #region wolves attack addition shepherd script

        private static OppositionGroup m_PredatorAndPrey = new OppositionGroup(new Type[][]
			{
				new Type[]
				{
                    typeof( ShepherdsSheep ),
                    typeof( Sheep),
				},
				new Type[]
				{
        ...
        public static OppositionGroup PredatorAndPrey
        {
            get { return m_PredatorAndPrey; }
        }
        #endregion
