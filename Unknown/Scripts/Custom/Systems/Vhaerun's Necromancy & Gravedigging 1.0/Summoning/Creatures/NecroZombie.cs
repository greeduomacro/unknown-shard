...
namespace Server.Mobiles
{
	...
	public class NecroZombie : BaseCreature
	{
		...
		[Constructable]
		public NecroZombie() : this( false, 1.0 )
		{
		}

		[Constructable]
		public NecroZombie( bool summoned, double scalar ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
			Name = "a Zombie";
			Body = 3;
			BaseSoundID = 0x48D;
		...
		public NecroZombie( Serial serial ) : base( serial )
		{
		}
