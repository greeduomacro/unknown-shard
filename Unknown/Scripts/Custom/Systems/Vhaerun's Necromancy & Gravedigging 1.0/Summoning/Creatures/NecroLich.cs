...
namespace Server.Mobiles
{
	...
	public class NecroLich : BaseCreature
	{
		...
		[Constructable]
		public NecroLich() : this( false, 1.0 )
		{
		}

		[Constructable]
		public NecroLich( bool summoned, double scalar ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
			Name = "a Lich";
			Body = 24;
			BaseSoundID = 0x48D;
		...
		public NecroLich( Serial serial ) : base( serial )
		{
		}
