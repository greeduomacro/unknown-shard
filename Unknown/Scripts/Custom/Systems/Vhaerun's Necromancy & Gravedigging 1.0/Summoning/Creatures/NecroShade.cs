...
{
	[CorpseName( "a shade corpse" )]
	public class NecroShade : BaseCreature
	{
		...
		[Constructable]
		public NecroShade() : this( false, 1.0 )
		{
		}

		[Constructable]
		public NecroShade( bool summoned, double scalar ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
			Name = "a Shade";
			Body = 26;
			BaseSoundID = 0x48D;
		...
		public NecroShade( Serial serial ) : base( serial )
		{
		}
