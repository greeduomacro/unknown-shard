...
{
	public class NecroSkeletonEssence : Item
	{
		[Constructable]
		public NecroSkeletonEssence() : base( 0x186F )
		{
			Weight = 1.0;
			Name = "Skeleton Essence";
			Hue = 0x2EF;
		}

		public NecroSkeletonEssence( Serial serial ) : base( serial )
		{
		}

		public override void OnDoubleClick( Mobile from )
		{
			double minSkill = 80.0;
			...
			if ( from.Mounted )
			{
				...
				{
					NecroSkeleton m = new NecroSkeleton( true, scalar );
					...
					if ( m.SetControlMaster( from ) )
					{
						...
						from.PlaySound( 0x24A );
						from.SendMessage( "You have summoned a skeleton." );
					}
				}
		}
