...
{
	public class NecroLichEssence : Item
	{
		[Constructable]
		public NecroLichEssence() : base( 0x186F )
		{
			Weight = 1.0;
			Name = "Lich Essence";
			Hue = 0x2EF;
		...
		public NecroLichEssence( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( from.Mounted )
			{
				...
				{
					NecroLich m = new NecroLich( true, scalar );
					...
					if ( m.SetControlMaster( from ) )
					{
						...
						from.PlaySound( 0x24A );
						from.SendMessage( "You have summoned a lich." );
					}
				}
		}
