...
{
	public class NecroMummyEssence : Item
	{
		[Constructable]
		public NecroMummyEssence() : base( 0x186F )
		{
			Weight = 1.0;
			Name = "Mummy Essence";
			Hue = 0x2EF;
		...
		public NecroMummyEssence( Serial serial ) : base( serial )
		{
		}

		public override void OnDoubleClick( Mobile from )
		{
			double minSkill = 95.0;
			...
			if ( from.Mounted )
			{
				...
				{
					NecroMummy m = new NecroMummy( true, scalar );
					...
					if ( m.SetControlMaster( from ) )
					{
						...
						from.PlaySound( 0x24A );
						from.SendMessage( "You have summoned a mummy." );
					}
				}
		}
