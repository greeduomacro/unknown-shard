...
{ 
   	public class PurplePetDye : Item 
   	{ 
    
      		[Constructable] 
      		public PurplePetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 18;
      		...
      		public PurplePetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new PurpleDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class PurpleDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private PurplePetDye m_Powder; 

         		public PurpleDyeTarget( PurplePetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
