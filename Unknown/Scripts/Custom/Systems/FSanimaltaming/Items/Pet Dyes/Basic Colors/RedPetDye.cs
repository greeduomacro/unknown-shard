...
{ 
   	public class RedPetDye : Item 
   	{ 
    
      		[Constructable] 
      		public RedPetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 2118;
      		...
      		public RedPetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new RedDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class RedDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private RedPetDye m_Powder; 

         		public RedDyeTarget( RedPetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
