...
{ 
   	public class MossGreenPetDye : Item 
   	{ 
    
      		[Constructable] 
      		public MossGreenPetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 1167;
         		Name="pet dye (Mystic Green)"; 
          	} 

      		public MossGreenPetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new MossGreenDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class MossGreenDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private MossGreenPetDye m_Powder; 

         		public MossGreenDyeTarget( MossGreenPetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
