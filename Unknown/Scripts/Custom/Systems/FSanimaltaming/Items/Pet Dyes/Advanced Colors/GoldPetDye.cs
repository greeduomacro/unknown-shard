...
{ 
   	public class GoldPetDye : Item 
   	{ 
    
      		[Constructable] 
      		public GoldPetDye() : base( 0xE2B ) 
      		{ 
         		Weight = 1.0;  
         		Movable = true;
			Hue = 51;
      		...
      		public GoldPetDye( Serial serial ) : base( serial ) 
      		{ 
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				...
				from.SendMessage( "What do you wish to dye?" ); 
           			from.Target = new GoldDyeTarget( this );
		        } 
		        else 
		        { 
  		...
  		private class GoldDyeTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private GoldPetDye m_Powder; 

         		public GoldDyeTarget( GoldPetDye charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
