...
namespace Server.Items
{
	...
	public class SleeperEWAddon: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
		...
		private SleeperEWAddon m_Sleeper;
	...
	public class SleeperEWPiece : AddonComponent
	{

		private SleeperEWAddon m_Sleeper;

		public SleeperEWPiece( SleeperEWAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperEWAddon)reader.ReadItem();
