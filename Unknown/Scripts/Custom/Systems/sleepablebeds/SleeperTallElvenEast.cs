...
// Author: Oak
// Servers: RunUO 2.0
// Date: 7/10/2006 (tall elven East)
// History: 
...
namespace Server.Items
{
	...
	public class SleeperTallElvenEast: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
        {
            get
            {
                return new SleeperTallElvenEastDeed ();
            }
        }

		public SleeperTallElvenEast( Serial serial ) : base( serial )
		{
		}

		[Constructable]
		public SleeperTallElvenEast( ) 
		{
			Visible = true;
			Name = "Sleeper";
			AddComponent( new SleeperTallElvenEastPiece( this, 0x3054 ), 0,  0, 0 );
			AddComponent( new SleeperTallElvenEastPiece( this, 0x3053 ), 1,  0, 0 );
			AddComponent( new SleeperTallElvenEastPiece( this, 0x3055 ), 2, -1, 0 );
			AddComponent( new SleeperTallElvenEastPiece( this, 0x3052 ), 2,  0, 0 );
		}
		
		private SleeperTallElvenEast m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperTallElvenEast Sleeper
		{
	...
	public class SleeperTallElvenEastPiece : AddonComponent
	{

		private SleeperTallElvenEast m_Sleeper;

		public SleeperTallElvenEastPiece( SleeperTallElvenEast sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperTallElvenEast)reader.ReadItem();

		}

	}
   public class SleeperTallElvenEastDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new SleeperTallElvenEast ();
            }
        }

        [Constructable]
        public SleeperTallElvenEastDeed ()
        {
            Name = "a tall elven sleepable bed facing East deed.";
        }

        public SleeperTallElvenEastDeed ( Serial serial )
            : base ( serial )
        {
        }
