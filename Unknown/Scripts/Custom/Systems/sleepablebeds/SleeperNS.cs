...
namespace Server.Items
{
	...
	public class SleeperNSAddon: BaseAddon, IChopable
	{
      public override BaseAddonDeed Deed
		...
		private SleeperNSAddon m_Sleeper;
	...
	public class SleeperNSPiece : AddonComponent
	{

		private SleeperNSAddon m_Sleeper;

		public SleeperNSPiece( SleeperNSAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperNSAddon)reader.ReadItem();
