...
{
	public class EntrappedSoulSkinningKnife : SkinningKnife
	{
		...
		[Constructable]
		public EntrappedSoulSkinningKnife()
		{
			Name = "Entrapped Soul Skinning Knife";
		...
		{
			private EntrappedSoulSkinningKnife i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulSkinningKnife std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulSkinningKnife( Serial serial ) : base( serial ) { }
