...
{
	public class EntrappedSoulDagger : Dagger
	{
		...
		[Constructable]
		public EntrappedSoulDagger()
		{
			Name = "Entrapped Soul Dagger";
		...
		{
			private EntrappedSoulDagger i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulDagger std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulDagger( Serial serial ) : base( serial ) { }
