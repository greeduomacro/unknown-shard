...
{
	public class EntrappedSoulQuarterStaff : QuarterStaff
	{
		...
		[Constructable]
		public EntrappedSoulQuarterStaff()
		{
			Name = "Entrapped Soul Quarter Staff";
		...
		{
			private EntrappedSoulQuarterStaff i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulQuarterStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulQuarterStaff( Serial serial ) : base( serial ) { }
