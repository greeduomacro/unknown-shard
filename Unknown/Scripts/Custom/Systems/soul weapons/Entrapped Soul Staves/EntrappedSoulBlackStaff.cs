...
{
	public class EntrappedSoulBlackStaff : BlackStaff
	{
		...
		[Constructable]
		public EntrappedSoulBlackStaff()
		{
			Name = "Entrapped Soul Black Staff";
		...
		{
			private EntrappedSoulBlackStaff i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulBlackStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulBlackStaff( Serial serial ) : base( serial ) { }
