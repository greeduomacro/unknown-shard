...
{
	public class EntrappedSoulShepherdsCrook : ShepherdsCrook
	{
		...
		[Constructable]
		public EntrappedSoulShepherdsCrook()
		{
			Name = "Entrapped Soul Shepherd's Crook";
		...
		{
			private EntrappedSoulShepherdsCrook i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulShepherdsCrook std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulShepherdsCrook( Serial serial ) : base( serial ) { }
