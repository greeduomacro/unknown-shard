...
{
	public class EntrappedSoulPickaxe : Pickaxe
	{
		...
		[Constructable]
		public EntrappedSoulPickaxe()
		{
			Name = "Entrapped Soul Pickaxe";
		...
		{
			private EntrappedSoulPickaxe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulPickaxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulPickaxe( Serial serial ) : base( serial ) { }
