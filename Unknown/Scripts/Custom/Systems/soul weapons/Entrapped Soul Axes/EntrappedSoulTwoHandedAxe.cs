...
{
	public class EntrappedSoulTwoHandedAxe : TwoHandedAxe
	{
		...
		[Constructable]
		public EntrappedSoulTwoHandedAxe()
		{
			Name = "Entrapped Soul Two Handed Axe";
		...
		{
			private EntrappedSoulTwoHandedAxe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulTwoHandedAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulTwoHandedAxe( Serial serial ) : base( serial ) { }
