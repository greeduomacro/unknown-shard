...
{
	public class EntrappedSoulExecutionersAxe : ExecutionersAxe
	{
		...
		[Constructable]
		public EntrappedSoulExecutionersAxe()
		{
			Name = "Entrapped Soul Executioner's Axe";
		...
		{
			private EntrappedSoulExecutionersAxe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulExecutionersAxe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulExecutionersAxe( Serial serial ) : base( serial ) { }
