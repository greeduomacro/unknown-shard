...
{
	public class EntrappedSoulBladedStaff : BladedStaff
	{
		...
		[Constructable]
		public EntrappedSoulBladedStaff()
		{
			Name = "Entrapped Soul Bladed Staff";
		...
		{
			private EntrappedSoulBladedStaff i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulBladedStaff std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulBladedStaff( Serial serial ) : base( serial ) { }
