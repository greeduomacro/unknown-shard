...
{
	public class EntrappedSoulWarFork : WarFork
	{
		...
		[Constructable]
		public EntrappedSoulWarFork()
		{
			Name = "Entrapped Soul War Fork";
		...
		{
			private EntrappedSoulWarFork i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulWarFork std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulWarFork( Serial serial ) : base( serial ) { }
