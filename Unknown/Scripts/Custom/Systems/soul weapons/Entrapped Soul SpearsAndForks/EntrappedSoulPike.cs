...
{
	public class EntrappedSoulPike : Pike
	{
		...
		[Constructable]
		public EntrappedSoulPike()
		{
			Name = "Entrapped Soul Pike";
		...
		{
			private EntrappedSoulPike i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulPike std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulPike( Serial serial ) : base( serial ) { }
