...
{
	public class EntrappedSoulScepter : Scepter
	{
		...
		[Constructable]
		public EntrappedSoulScepter()
		{
			Name = "Entrapped Soul Scepter";
		...
		{
			private EntrappedSoulScepter i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulScepter std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulScepter( Serial serial ) : base( serial ) { }
