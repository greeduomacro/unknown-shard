...
{
	public class EntrappedSoulWarHammer : WarHammer
	{
		...
		[Constructable]
		public EntrappedSoulWarHammer()
		{
			Name = "Entrapped Soul War Hammer";
		...
		{
			private EntrappedSoulWarHammer i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulWarHammer std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulWarHammer( Serial serial ) : base( serial ) { }
