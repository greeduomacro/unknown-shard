...
{
	public class EntrappedSoulWarMace : WarMace
	{
		...
		[Constructable]
		public EntrappedSoulWarMace()
		{
			Name = "Entrapped Soul War Mace";
		...
		{
			private EntrappedSoulWarMace i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulWarMace std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulWarMace( Serial serial ) : base( serial ) { }
