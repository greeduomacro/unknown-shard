...
{
	public class EntrappedSoulMaul : Maul
	{
		...
		[Constructable]
		public EntrappedSoulMaul()
		{
			Name = "Entrapped Soul Maul";
		...
		{
			private EntrappedSoulMaul i_Std;
			private int m_Charges;
		...
		public EntrappedSoulMaul( Serial serial ) : base( serial ) { }
