...
{
	public class EntrappedSoulHammerPick : HammerPick
	{
		...
		[Constructable]
		public EntrappedSoulHammerPick()
		{
			Name = "Entrapped Soul Hammer Pick";
		...
		{
			private EntrappedSoulHammerPick i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulHammerPick std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulHammerPick( Serial serial ) : base( serial ) { }
