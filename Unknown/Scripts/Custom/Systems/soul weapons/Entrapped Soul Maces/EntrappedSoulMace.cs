...
{
	public class EntrappedSoulMace : Mace
	{
		...
		[Constructable]
		public EntrappedSoulMace()
		{
			Name = "Entrapped Soul Mace";
		...
		{
			private EntrappedSoulMace i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulMace std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulMace( Serial serial ) : base( serial ) { }
