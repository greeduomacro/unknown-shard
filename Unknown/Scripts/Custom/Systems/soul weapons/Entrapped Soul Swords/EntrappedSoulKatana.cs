...
{
	public class EntrappedSoulKatana : Katana
	{
		...
		[Constructable]
		public EntrappedSoulKatana()
		{
			Name = "Entrapped Soul Katana";
		...
		{
			private EntrappedSoulKatana i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulKatana std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulKatana( Serial serial ) : base( serial ) { }
