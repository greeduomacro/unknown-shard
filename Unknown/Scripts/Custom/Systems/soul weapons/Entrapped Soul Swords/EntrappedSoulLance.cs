...
{
	public class EntrappedSoulLance : Lance
	{
		...
		[Constructable]
		public EntrappedSoulLance()
		{
			Name = "Entrapped Soul Lance";
		...
		{
			private EntrappedSoulLance i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulLance std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulLance( Serial serial ) : base( serial ) { }
