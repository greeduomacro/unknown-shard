...
{
	public class EntrappedSoulVikingSword : VikingSword
	{
		...
		[Constructable]
		public EntrappedSoulVikingSword()
		{
			Name = "Entrapped Soul Viking Sword";
		...
		{
			private EntrappedSoulVikingSword i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulVikingSword std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulVikingSword( Serial serial ) : base( serial ) { }
