...
{
	public class EntrappedSoulBoneHarvester : BoneHarvester
	{
		...
		[Constructable]
		public EntrappedSoulBoneHarvester()
		{
			Name = "Entrapped Soul Bone Harvester";
		...
		{
			private EntrappedSoulBoneHarvester i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulBoneHarvester std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulBoneHarvester( Serial serial ) : base( serial ) { }
