...
{
	public class EntrappedSoulCutlass : Cutlass
	{
		...
		[Constructable]
		public EntrappedSoulCutlass()
		{
			Name = "Entrapped Soul Cutlass";
		...
		{
			private EntrappedSoulCutlass i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulCutlass std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulCutlass( Serial serial ) : base( serial ) { }
