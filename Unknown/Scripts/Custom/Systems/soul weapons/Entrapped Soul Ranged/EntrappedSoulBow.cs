...
{
	public class EntrappedSoulBow : Bow
	{
		...
		[Constructable]
		public EntrappedSoulBow()
		{
			Name = "Entrapped Soul Bow";
		...
		{
			private EntrappedSoulBow i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulBow std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulBow( Serial serial ) : base( serial ) { }
