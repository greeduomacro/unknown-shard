...
{
	public class EntrappedSoulCrossbow : Crossbow
	{
		...
		[Constructable]
		public EntrappedSoulCrossbow()
		{
			Name = "Entrapped Soul Crossbow";
		...
		{
			private EntrappedSoulCrossbow i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulCrossbow std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulCrossbow( Serial serial ) : base( serial ) { }
