...
{
	public class EntrappedSoulScythe : Scythe
	{
		...
		[Constructable]
		public EntrappedSoulScythe()
		{
			Name = "Entrapped Soul Scythe";
		...
		{
			private EntrappedSoulScythe i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulScythe std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulScythe( Serial serial ) : base( serial ) { }
