...
{
	public class EntrappedSoulHalberd : Halberd
	{
		...
		[Constructable]
		public EntrappedSoulHalberd()
		{
			Name = "Entrapped Soul Halberd";
		...
		{
			private EntrappedSoulHalberd i_Std;
			private int m_Charges;
			public EntrappedSoulTarget( EntrappedSoulHalberd std ) : base( -1, false, TargetFlags.None ) { i_Std = std; }
		...
		public EntrappedSoulHalberd( Serial serial ) : base( serial ) { }
