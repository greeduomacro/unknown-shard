...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft( typeof( ArchitectTool ), 1044046, "architect tool", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
			#endregion
			...
			AddSubRes( typeof( SilverIngot ),       	"SILVER", 90.0, 1044268 );
			AddSubRes( typeof( PlatinumIngot ),     	"PLATINUM", 90.0, 1044268 );
			AddSubRes( typeof( MythrilIngot ),      	"MYTHRIL", 90.0, 1044268 );
			AddSubRes( typeof( ObsidianIngot ),     	"OBSIDIAN", 90.0, 1044268 );
			AddSubRes( typeof( JadeIngot ),         	"JADE", 90.0, 1044268 );
			AddSubRes( typeof( MoonstoneIngot ),    	"MOONSTONE", 90.0, 1044268 );
			AddSubRes( typeof( SunstoneIngot ),     	"SUNSTONE", 90.0, 1044268 );
			AddSubRes( typeof( BloodstoneIngot ),   	"BLOODSTONE", 90.0, 1044268 );
