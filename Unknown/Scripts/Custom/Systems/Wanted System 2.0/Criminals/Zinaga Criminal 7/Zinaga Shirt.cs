...
namespace Server.Items
{
	...
	public class Zinagashirt : BaseShirt 
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public Zinagashirt() : this( 0 )
		{
		}

		[Constructable]
		public Zinagashirt( int hue ) : base( 0x1EFD, hue )
		{
			Name = "Zinaga's Shirt";
			Hue = 1;
        ...
        public Zinagashirt(Serial serial): base(serial) 
		{ 
			DefineMods();
