...
namespace Server.Items
{
	...
	public class MarineBoots : BaseShoes
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public MarineBoots() : this( 0 )
		{
		}

		[Constructable]
		public MarineBoots( int hue ) : base( 0x170B, hue )
		{
			Name = "Marines Boots";
			Hue = 1;
        ...
        public MarineBoots(Serial serial): base(serial) 
		{ 
			DefineMods();
