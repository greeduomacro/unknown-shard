...
namespace Server.Items
{
	...
	public class WickedClownBoots : BaseShoes
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public WickedClownBoots() : this( 0 )
		{
		}

		[Constructable]
		public WickedClownBoots( int hue ) : base( 0x170B, hue )
		{
			Name = "WickedClowns Boots";
			Hue = 1;
		...
		{ 
			...
			{ 
				...
				m.RemoveStatMod( "WickedClownBoots" );
        ...
        public WickedClownBoots(Serial serial): base(serial) 
		{ 
			DefineMods();
