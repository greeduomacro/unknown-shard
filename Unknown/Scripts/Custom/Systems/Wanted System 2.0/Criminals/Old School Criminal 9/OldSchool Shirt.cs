...
namespace Server.Items
{
	...
	public class OldSchoolshirt : BaseShirt 
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public OldSchoolshirt() : this( 0 )
		{
		}

		[Constructable]
		public OldSchoolshirt( int hue ) : base( 0x1EFD, hue )
		{
			Name = "OldSchool's Shirt";
			Hue = 1;
		...
		{ 
			...
			{ 
				...
				m.RemoveStatMod( "OldSchoolshirt" );
        ...
        public OldSchoolshirt(Serial serial): base(serial) 
		{ 
			DefineMods();
