...
namespace Server.Items
{
	...
	public class FreshPants : BasePants
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public FreshPants() : this( 0 )
		{
		}

		[Constructable]
		public FreshPants( int hue ) : base( 0x1539, hue )
		{
			Name = "Fresh's Pants";
			Hue = 1;
        ...
        public FreshPants(Serial serial): base(serial) 
		{ 
			DefineMods();
