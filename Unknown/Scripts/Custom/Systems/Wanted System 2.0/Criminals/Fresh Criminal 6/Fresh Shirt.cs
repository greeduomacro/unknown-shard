...
namespace Server.Items
{
	...
	public class Freshshirt : BaseShirt 
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public Freshshirt() : this( 0 )
		{
		}

		[Constructable]
		public Freshshirt( int hue ) : base( 0x1EFD, hue )
		{
			Name = "Fresh's Shirt";
			Hue = 1;
        ...
        public Freshshirt(Serial serial): base(serial) 
		{ 
			DefineMods();
