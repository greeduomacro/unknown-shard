...
namespace Server.Items
{
	...
	public class FanalaonBoots : BaseShoes
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public FanalaonBoots() : this( 0 )
		{
		}

		[Constructable]
		public FanalaonBoots( int hue ) : base( 0x170B, hue )
		{
			Name = "Fanalaons Boots";
			Hue = 1;
