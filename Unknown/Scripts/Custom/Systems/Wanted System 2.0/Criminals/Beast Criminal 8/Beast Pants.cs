...
namespace Server.Items
{
	...
	public class BeastPants : BasePants
	{
        private SkillMod m_SkillMod0;
        private SkillMod m_SkillMod1;
     		
		[Constructable]
		public BeastPants() : this( 0 )
		{
		}

		[Constructable]
		public BeastPants( int hue ) : base( 0x1539, hue )
		{
			Name = "Beast's Pants";
			Hue = 1;
        ...
        public BeastPants(Serial serial): base(serial) 
		{ 
			DefineMods();
