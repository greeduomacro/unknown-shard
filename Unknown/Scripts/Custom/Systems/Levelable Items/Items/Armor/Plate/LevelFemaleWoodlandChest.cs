...
namespace Server.Items
{
    ...
    public class LevelFemaleElvenPlateChest : BaseLevelArmor
	{
		...
		[Constructable]
		public LevelFemaleElvenPlateChest() : base( 0x2B6D )
		{
			Weight = 8.0;
		}

		public LevelFemaleElvenPlateChest( Serial serial ) : base( serial )
		{
		}
