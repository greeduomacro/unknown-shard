...
{
	public class PoisonDipTub : BaseTub
	{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( targeted != null && targeted is Arrow )
				{
					if ( it_Tub != null )
					{
						...
						{
							from.SendMessage( "You carefully apply the venomous material to your bundle of arrows." );
							
							it_Tub.Charges--;
							arrow.Consume( 20 );
							//Note: pack.ConsumeTotal( typeof(Arrow), 20 )
							from.AddToBackpack( new PoisonArrow( 20 ) );
						}
				...
				else if ( targeted != null && targeted is Bolt )
				{
					if ( it_Tub != null )
					{
						...
						{
							from.SendMessage( "You carefully apply the venomous material to your bundle of bolts." );
							
							it_Tub.Charges--;
							bolt.Consume( 20 );
							//Note: pack.ConsumeTotal( typeof(Bolt), 20 )
							from.AddToBackpack( new PoisonBolt( 20 ) );
						}
