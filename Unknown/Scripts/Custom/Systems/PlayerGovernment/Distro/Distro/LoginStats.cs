...
namespace Server.Misc
{
	public class LoginStats
	{
		...
		private static void EventSink_Login( LoginEventArgs args )
		{
			...
			Mobile m = args.Mobile;						//THESE LINES ADDED TO BRING NEW SKILL CAPS TO PRE-EXISTING PLAYERMOBILES
            //THESE LINES ADDED TO BRING NEW SKILL CAPS TO PRE-EXISTING PLAYERMOBILES
            for (int i = 0; i < SkillInfo.Table.Length; i++)		//THESE LINES ADDED TO BRING NEW SKILL CAPS TO PRE-EXISTING PLAYERMOBILES
            {								//THESE LINES ADDED TO BRING NEW SKILL CAPS TO PRE-EXISTING PLAYERMOBILES
                m.Skills[i].Cap = 15100.0;//ADD NEW INDIVIDUAL SKILL CAPS HERE	//THESE LINES ADDED TO BRING NEW SKILL CAPS TO PRE-EXISTING PLAYERMOBILES							//THESE LINES ADDED TO BRING NEW SKILL CAPS TO PRE-EXISTING PLAYERMOBILES
