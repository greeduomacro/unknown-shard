...
private bool m_HideFromLogInOut;
  private bool m_SeeLogInOut;

   [CommandProperty( AccessLevel.GameMaster )]
   public bool HideFromLogInOut
   {
       get{ return m_HideFromLogInOut; }
       set{ m_HideFromLogInOut = value; }
   }

   [CommandProperty( AccessLevel.GameMaster )]
   public bool SeeLogInOut
   {
       get{ return m_SeeLogInOut; }
       set{ m_SeeLogInOut = value; }
   }
		...
		public override int MaxWeight { get { return (((Core.ML && this.Race == Race.Human) ? 100 : 40) + (int)(4.5 * this.Str)); } }
...
public override void Resurrect()
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 30:
				{
					m_HideFromLogInOut = reader.ReadBool();
					m_SeeLogInOut = reader.ReadBool();
					goto case 29;
				}
				case 29:
				{
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (bool) m_HideFromLogInOut );
			writer.Write( (bool) m_SeeLogInOut );
