...
namespace Server.Items
{
	...
	{
		[Constructable]
		public SmallCityParkDeed() : base( 0x1406, new Point3D( 0, 5, 0 ) )
		{
			Name = "a small park deed";
			Type = CivicStrutureType.SmallCityPark;
		}

		public SmallCityParkDeed( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( pm.City != null )
			{
				...
				else if ( PlayerGovernmentSystem.NeedsForensics && from.Skills[SkillName.Forensics].Base < 70.0 )
				{
					from.SendMessage( "You lack the required skill to place this building, You need at least 70.0 points in forensics." );
				}
				else
				{
