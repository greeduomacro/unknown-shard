...
{
	public class ABankerContract : Item
	{

		[Constructable]
		public ABankerContract() : base( 0x2831 )
		{
		    Hue = 1161;
		    Name = "Banker Contract";
			Weight = 0.1;
			LootType = LootType.Blessed;
		}

		public ABankerContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new ABanker();//( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new ABanker();//( from, house );
