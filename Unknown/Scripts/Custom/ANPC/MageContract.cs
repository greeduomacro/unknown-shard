...
{
	public class AMageContract : Item
	{

		[Constructable]
		public AMageContract() : base( 0x2831 )
		{
		    Hue = 98;
		    Name = "Mage Contract";
			Weight = 0.1;
		...
		public AMageContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new AMage();//( from, BaseHouse.FindHouseAt( from ) );
