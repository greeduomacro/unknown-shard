...
{
	public class ATailorContract : Item
	{

		[Constructable]
		public ATailorContract() : base( 0x2831 )
		{
		    Hue = 171;
		    Name = "Tailor Contract";
			Weight = 0.1;
			LootType = LootType.Blessed;
		}

		public ATailorContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new ATailor();//( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new ATailor();//( from, house );
