...
{
	public class AAnimalTrainerContract : Item
	{

		[Constructable]
		public AAnimalTrainerContract() : base( 0x2831 )
		{
		    Hue = 1257;
		    Name = "Animal Trainer Contract";
			Weight = 0.1;
			LootType = LootType.Blessed;
		}

		public AAnimalTrainerContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new AAnimalTrainer();//( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else
				{
					...
					{
						Mobile v = new AAnimalTrainer();//( from, house );
