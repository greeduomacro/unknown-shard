...
namespace Server.Mobiles
{
	public class AAnimalTrainer : BaseVendor
	{
		...
		{
			private AAnimalTrainer m_Trainer;
			private Mobile m_From;

			public StableEntry( AAnimalTrainer trainer, Mobile from ) : base( 6126, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class ClaimListGump : Gump
		{
			...
			public ClaimListGump( AAnimalTrainer trainer, Mobile from, List<BaseCreature> list ) : base( 50, 50 )             //ArrayList list ) : base( 50, 50 )
			{
				m_Trainer = trainer;
				m_From = from;
				m_List = list;
		...
		private class ClaimAllEntry : ContextMenuEntry
		{
			...
			public ClaimAllEntry( AAnimalTrainer trainer, Mobile from ) : base( 6127, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class StableTarget : Target
		{
			...
			public StableTarget( AAnimalTrainer trainer ) : base( 12, false, TargetFlags.None )
			{
				m_Trainer = trainer;
			}
		...
		public void BeginClaimList( Mobile from )
		{
			...
			List<BaseCreature> list = new List<BaseCreature>(); //ArrayList list = new ArrayList();
		...
		public AAnimalTrainer( Serial serial ) : base( serial )
		{
		}
