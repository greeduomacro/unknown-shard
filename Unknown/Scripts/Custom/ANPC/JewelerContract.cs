...
{
	public class AJewelerContract : Item
	{
		//public override int LabelNumber{ get{ return 1041243; } } // a contract of employment

		[Constructable]
		public AJewelerContract() : base( 0x2831 )
		{
		    Hue = 37;
		    Name = "Jeweler Contract";
			Weight = 0.1;
			LootType = LootType.Blessed;
		}

		public AJewelerContract( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.AccessLevel >= AccessLevel.GameMaster )
			{
				...
				Mobile v = new AJeweler();//( from, BaseHouse.FindHouseAt( from ) );
			...
			else
			{
				...
				else if ( BaseHouse.NewVendorSystem && !house.IsCoOwner( from ) )
				{
				...
				else
				{
					...
					{
						Mobile v = new AJeweler();//( from, house );
