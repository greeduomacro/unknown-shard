...
{
	public class AProvisionerContract : Item
	{

		[Constructable]
		public AProvisionerContract() : base( 0x2831 )
		{
		    Hue = 1364;
		    Name = "Provisioner Contract";
			Weight = 0.1;
			LootType = LootType.Blessed;
		}

		public AProvisionerContract( Serial serial ) : base( serial )
		{
		}
