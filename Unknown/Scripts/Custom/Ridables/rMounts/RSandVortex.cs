...
namespace Server.Mobiles
{
	...
	public class RSandVortex : BaseMount
	{
		
		[Constructable]
		public RSandVortex() : this( "a ridable sand vortex" )
		{
		}

		[Constructable]
		public RSandVortex( string name ) : base( name, 0x316, 0x3F0A, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a ridable sand vortex";
			Body = 790;
			BaseSoundID = 263;
		...
		public RSandVortex( Serial serial ) : base( serial )
		{
		}
