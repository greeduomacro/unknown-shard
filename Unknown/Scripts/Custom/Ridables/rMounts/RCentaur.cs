...
namespace Server.Mobiles
{
	...
	public class RCentaur : BaseMount
	{
		[Constructable]
		public RCentaur() : this( "a ridable Centaur" )
		{
		}

		[Constructable]
		public RCentaur( string name ) : base( name, 0x65, 0x3F10, AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public RCentaur( Serial serial ) : base( serial )
		{
		}
